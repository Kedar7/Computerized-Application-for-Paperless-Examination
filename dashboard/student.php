        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">
                  <h3 style="color:#777777;"> <span style="color:#e77637;"><?php echo $row[1];?></span></h3>
                </h3>
            </div>
...
<div class="container">
  <h4 style="color:#777777;"><strong>Attended Exams</strong></h4>
  <p>These are the list of exams you have applied.</p>        
<input id="myInput" type="text" placeholder="Search..">    
  <div class="table-responsive" style="border:1px  black;width:100%;height:200px;overflow:scroll;">          
  <table class="table">
  ...
  $sql="select Examid from registration where JobSeekerID = $row[0] and attended ='1'";
  $records =mysqli_query($connect,$sql);
 $count = 0;
  while($row = mysqli_fetch_array($records))
{
